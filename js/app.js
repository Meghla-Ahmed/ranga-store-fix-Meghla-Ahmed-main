...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <p>
      <i class="far fa-star"></i> ${product.rating.rate}</p>
      ...
      <button onclick="loadSingleProduct(${product.id})" id="details-btn" class="btn"type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">Details</button>
      </div>
...
/*-------------
loading data to show single product details
-------------*/
